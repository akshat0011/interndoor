...
Which is the honest summary of the architecture: it fits *this* problem — one person's watchlist, twice a day, public data. Change any of those and the file stops being the answer. Knowing where your clever choice breaks is worth more than the choice.
